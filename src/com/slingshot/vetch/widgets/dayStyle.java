...
public class dayStyle
{
	...
	private static String[] getWeekDayNames()
	{
		...
		vec[Calendar.SUNDAY] = "Su";
		vec[Calendar.MONDAY] = "Mo";
		vec[Calendar.TUESDAY] = "Tu";
		vec[Calendar.WEDNESDAY] = "We";
		vec[Calendar.THURSDAY] = "Th";
		vec[Calendar.FRIDAY] = "Fr";
		vec[Calendar.SATURDAY] = "Sa";
		return vec;		
	}
