...
public class DateWidget extends Activity
{
	...
	//fields
	private boolean bNoneButton = false;
	...
	private static int iDayCellSize = 38;         //38
    ...
    void setVolues(){
        ...
        float k= (float) (1.00*width/320);
       // Toast.makeText(this,""+k,Toast.LENGTH_SHORT).show();
        iDayCellSize= (int) Math.abs(k * 38);
  ...
  public void onCreate(Bundle icicle)
  {
  	...
  	if (data != null)
  	{
  		if (data.containsKey("date"))
  			calSelected.setTimeInMillis(0);   //   data.getLong("date")
  ...
  {
    Intent it = new Intent("android.intent.action.AnCal.ACTION_MODE_EDIT_SELECT_DATE_sl");
