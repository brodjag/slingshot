...
package com.slingshot.vetch.widgets;
...
public class KeyboardWidget extends Activity
{
  ...
  public LinearLayout createLayout(int iOrientation)
  {
		...
		lay.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
  ...
  {
  	TextView labMargin = createLabel("", 8, ViewGroup.LayoutParams.FILL_PARENT);

  	btnCancel = createButton(sStrCancel, iSmallButtonWidth, ViewGroup.LayoutParams.WRAP_CONTENT);
  	btnCancel.setBackgroundResource(android.R.drawable.btn_default_small);

  	btnSet = createButton(sStrSet, iSmallButtonWidth, ViewGroup.LayoutParams.WRAP_CONTENT);
  ...
  public HintEdit createEditBox()
  {
  	edit = new HintEdit(this);
		edit.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
		edit.setLines(3);
